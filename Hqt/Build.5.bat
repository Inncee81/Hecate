...
echo -reference:"%dotNetCore%\System.Collections.NonGeneric.dll"                  >> "Build.rsp"
...
echo -reference:"%dotNetCore%\System.Diagnostics.TraceSource.dll"                 >> "Build.rsp"
echo -reference:"%dotNetCore%\System.Drawing.Primitives.dll"                      >> "Build.rsp"
...
echo -reference:"%dotNetCore%\System.Runtime.Serialization.Formatters.dll"        >> "Build.rsp"
...
echo -reference:"%dotNetCore%\System.Private.Xml.dll"                             >> "Build.rsp"
echo -reference:"%dotNetCore%\System.Xml.ReaderWriter.dll"                        >> "Build.rsp"
echo -reference:"%dotNetCore%\WindowsBase.dll"                                    >> "Build.rsp"
echo -reference:"%dotNetWin%\System.Drawing.Common.dll"                           >> "Build.rsp"
