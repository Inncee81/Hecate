...
namespace SE.Hecate.Sharp
{
    ...
    {
        const string ReferenceAssemblyPath = "%ProgramFiles%/Reference Assemblies/Microsoft/Framework/.NETFramework/v4.5.2";
        const string ReferenceAssembliesAlternativePath = "%ProgramFiles(x86)%/Reference Assemblies/Microsoft/Framework/.NETFramework/v4.5.2";
