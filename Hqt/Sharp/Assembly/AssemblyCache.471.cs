...
namespace SE.Hecate.Sharp
{
    ...
    public partial class AssemblyCache
    {
        ...
        const string ReferenceAssemblyPath = "%ProgramFiles(x86)%/Reference Assemblies/Microsoft/Framework/.NETFramework/v4.7.1";
        const string ReferenceAssembliesAlternativePath = "%ProgramFiles%/Reference Assemblies/Microsoft/Framework/.NETFramework/v4.7.1";
