...
namespace System.Resources
{
    ...
    public partial class ResXResourceReader : IResourceReader
    {
        ...
        private Point GetPosition(XmlReader reader)
        {
            ...
            IXmlLineInfo lineInfo; if ((lineInfo = reader as IXmlLineInfo) != null)
            {
        ...
        private void ParseXml(XmlTextReader reader)
        {
            ...
            try
            {
                ...
                {
                    Point pt = GetPosition(reader);
                    string newMessage = tie.InnerException.Message;
                ...
                {
                    if (Utils.IsCriticalException(e))
                    {
                        throw;
                    }
                    else
                    {
                        ...
                        throw new ArgumentException(xmlEx.Message, xmlEx);
                    }
                }
            }
            finally
        ...
        private void ParseDataNode(XmlTextReader reader, bool isMetaData)
        {
            ...
            {
                throw new ArgumentException(nodeInfo.ValueData);
            }
